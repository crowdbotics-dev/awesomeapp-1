"""
Django settings for awesomeapp_1 project.
...
ROOT_URLCONF = 'awesomeapp_1.urls'
...
WSGI_APPLICATION = 'awesomeapp_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "awesomeApp Support <support@awesomeapp-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "awesomeapp_1 API",
    "DESCRIPTION": "API documentation for awesomeapp_1 App",
    "VERSION": "v1",
}
